    ...
    <div className="relative flex min-h-screen bg-purple-950">
      ...
      >
        ...
        <div className="border-t border-purple-800 p-4">
          <button className="w-full flex items-center gap-4 px-4 py-3 rounded-lg text-purple-200 hover:text-white hover:bg-purple-800 transition group">
        ...
        <div className="md:hidden fixed inset-0 z-30 bg-black/50" onClick={() => setMobileMenuOpen(false)}>
          ...
          >
            ...
            <div className="border-t border-purple-800 p-4 m-4">
              <button className="w-full flex items-center gap-4 px-4 py-3 rounded-lg text-purple-200 hover:text-white hover:bg-purple-800 transition">
